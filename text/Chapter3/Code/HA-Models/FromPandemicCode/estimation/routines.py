...
def simulate_original_epsilons(impulses, outputs, T_sim,epsilons):
    """
    impulses: list of ImpulseDicts, each an impulse to independent unit normal shock
    outputs: list of outputs we want in simulation
    T_sim: length of simulation
...
def simulate_simple(impulses, outputs, T_sim,epsilons):
    """
    impulses: list of ImpulseDicts, each an impulse to independent unit normal shock
    outputs: list of outputs we want in simulation
    T_sim: length of simulation
    ...
    for o in outputs:
        simulation[o] = simul_shock(impulses[0][o], epsilons[0])
