...
\medskip
\begin{minipage}{0.51\textwidth}
\includegraphics[scale=.57]{text/chapter1/Figures/GR_sim/Cleaner/C_pandemic}
\label{fig:c}
\end{minipage}\hspace*{\fill}
\begin{minipage}{0.51\textwidth}
\includegraphics[scale=.57]{text/chapter1/Figures/GR_sim/Cleaner/GDP_pandemic}
 \label{fig:d}
\end{minipage}
...
\begin{figure}[!ht!]
\begin{center}
\includegraphics[scale=.52]{text/chapter1/Figures/pandemic_counterfactual/output_vs_data_jam_COVID_counterfactual}
\end{center}
...
\begin{figure}[!ht!]
\begin{center}
\includegraphics[scale=.52]{text/chapter1/Figures/pandemic_counterfactual/income_gini_pandemic_counterfactual_perm_only}
\end{center}
